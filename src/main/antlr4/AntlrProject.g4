...
//forstmt: 'for' '(' (varDecl | assignment)? ';' expr? ';' assignment? ')' stmt ;
//
//
//// Блоки
//blockstmt: '{' stmt* '}' ;
...
// Циклы
whilestmt: 'while' '(' expr ')' stmt ;
forstmt: 'for' '(' (varDecl | assignment)? SEMICOLON expr? SEMICOLON assignment? ')' stmt ;
